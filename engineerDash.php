        ...
        <div class="container-fluid">
            ...
            <div class="navbar-collapse collapse" id="navbar">
                <ul class="navbar-right nav navbar-nav">
                    <li class="dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false"><i class="fa fa-fw fa-bell-o"></i> <?php echo $user?>  <span class="badge">1</span></a>
                    ...
                    <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="#" class="navbar-link">Menu<span class="caret"></span></a>
                        <ul role="menu" class="dropdown-menu">
                            <li class="active"><a class="animate" href="engineerDash.php">Dashboard</a></li>
                            ...
                            <li><a class="animate" href="adminConsole.php">Admin Console</a></li>
                        </ul>
                    </li>
                </ul>
            </div>
...
<Br>
<div align="center">
    <form action="searchTicket.php" method="get" display: inline-block>
        <div align="centre">
            <h4>View Ticket;</h4>
    ...
    <div id="formContainer">
            ...
            <div class="table-wrapper-scroll-y my-custom-scrollbar" align="center">
                <table class="table table-bordered table-striped mb-0 table-hover" id="table1">
                    ...
                    if ($conn->connect_error) {
                        ...
                        $sql = "SELECT ticketId,username,subject,ticketStatus,ticketType,issueType,description,created_at,assignedTechnician,sla from ticket where assignedTechnician ='$username2' and ticketStatus !='RESOLVED'";
        ...
        <div align="center">
            ...
            <div id="formContainer">
                <div>
                    <div class="table-wrapper-scroll-y my-custom-scrollbar" align="center">
                        <table class="table table-bordered table-striped mb-0 table-hover" id="table12">
                            ...
                            if ($conn->connect_error) {
                                ...
                                $sql = "SELECT ticketId,username,subject,ticketStatus,ticketType,issueType,description,created_at,assignedTechnician,sla from ticket where assignedTechnician = 'UNASSIGNED'";
                            ...
                            <Script>
                                ...
                                var table = document.getElementById('table12'),rIndex;
