...
// Check connection
    ...
    $notesSQL = "select * from notes where ticketId = '$searchID' ORDER BY createdDate DESC";
                    ...
                    <div class="form-group">
                        ...
                        <div id="formContainer">
                            <div id="form1">
                                ...
                                <form action="saveTicket.php" method="get" display: inline-block>
                                            ...
                                            <section class="container">
                                                ...
                                                <div class="left-half">
                                                    <article>
                                                        ...
                                                        Note Type <select name = "noteType"  style="width: 350px" class="form-control"/>  <option value="F">Engineer Only</option>
                                                        <option value="T">User Visible</option>
                                                        <option value="R">Resolution</option></select><br>
                                                        Add Notes/Resolution<textarea name="notes" class="form-control" rows="9" textarea maxlength="255"  style="width: 350px"></textarea><br>
                                                        <a href='engineerDash.php'><input type="button" name="display" value="Exit"class="btn btn-primary" /></a>
                                                        <input type="submit" class="btn btn-primary" name="sbmtTicket2" value="Save Ticket" />
                                                        <input type="submit" class="btn btn-primary" name="sbmtTicket3" value="Resolve Ticket" />
                                                    </article>
                                                </div>
