...
//error_reporting(0)
        ...
        <div align="center">
            <div>
                Thank you for submitting your Ticket to the Help-Desk<Br>
                Your Ticket reference number is: <B><?php echo $row['ticketId'] ?></B>  -  Please quote this number when contacting the IT Department.<br><br><br>
                                ...
                                <div id="formContainer3">
                                    <div2 id="formContainer2">
                                        ...
                                        <section class="container">
                                            ...
                                            <div class="left-half">
                                                <article>
                                                    TICKET NUMBER<input type="text" class="form-control" name="ticketNumber"  style="width: 350px" value="<?php echo $row['ticketId'] ?>" readonly="true"/><br>
                                                    ...
                                                    <button class="btn btn-primary" onclick="document.location = 'userDashboard.php'">Back to Dashboard</button>
                                                </article>
                                            </div>
