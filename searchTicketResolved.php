...
// Check connection
    ...
    $notesSQL2 = "select * from notes where ticketId = '$searchID' and userVisible ='R'";
    $result20002 = mysqli_query($conn,$notesSQL2);
                            ...
                            <div id="form1">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div align="left" class="rounded">
                                            ...
                                            Requester <select name = "requester" readonly="true" style="width: 19%;"/><option value="<?php echo $row['username'] ?>"selected hidden><?php echo $row['username'] ?></option><?PHP while ($rows = mysqli_fetch_array($result8)):;?> <option value="<?php echo $rows[2];?>"> <?php echo $rows[2];?></option> <?php endwhile;?></select>
                                            Subject <input type="text" readonly="true" name="subject" required style="width: 35%" value="<?php echo $row['subject'] ?>"/>
                                            Priority <select name = "priority"  readonly="true" style="width: 15%;"/><option value="<?php echo $row['ticketType'] ?>"selected hidden ><?php echo $row['ticketType'] ?></option><?PHP while ($rows = mysqli_fetch_array($result6)):;?> <option value="<?php echo $rows[1];?>"> <?php echo $rows[1];?></option> <?php endwhile;?></select>
                                            Status <select name = "status" readonly="true"  style="width: 13%;"/><option value="<?php echo $row['ticketStatus'] ?>"selected hidden ><?php echo $row['ticketStatus'] ?></option><?PHP while ($rows = mysqli_fetch_array($result7)):;?> <option value="<?php echo $rows[1];?>"> <?php echo $rows[1];?></option> <?php endwhile;?></select>
                                    ...
                                    <div id="formContainer3">
                                        <div2 id="formContainer2">
                                            ...
                                            <section class="container">
                                                ...
                                                <div class="left-half">
                                                    <article>
                                                        TICKET NUMBER<input type="text" readonly="true" class="form-control" name="ticketNumber" required style="width: 350px" value="<?php echo $row['ticketId'] ?>" readonly="true"/><br>
                                                        Description of Issue (Max 255 Characters)*<textarea class="form-control" readonly="true" NAME="description" rows="9" textarea maxlength="255" required style="width: 350px"><?php echo $row['description']?></textarea><br><Br>
                                                        Resolution <textarea class="form-control  name = description" rows="12" textarea maxlength="255" readonly style="width: 350px"><?PHP while ($rows = mysqli_fetch_array($result20002)):;?><?php echo "RESOLVED ON: "," $rows[2]","\n\n"; echo "$rows[4]"; endwhile;?></textarea>
                                                ...
                                                <div class="right-half">
                                                    <article>
                                                        ...
                                                        Expected Completion Date<input type="text" readonly="true" class="form-control" name="compDate" required style="width: 350px" readonly value=""/><br>
