...
$pageName = "My Helpdesk Dashboard";
        ...
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a href="userDashboard.php" class="navbar-brand hidden-xs" align>Kilwaughter IT HELP-DESK &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
                    ...
                    &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
                    &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<?php echo $pageName?>
                </a>
            </div>
                ...
                <ul class="navbar-right nav navbar-nav">
                    ...
                    <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="#" class="navbar-link">Menu<span class="caret"></span></a>
                        <ul role="menu" class="dropdown-menu">
                            <li class="active"><a class="animate" href="userDashboard.php">Dashboard</a></li>
...
<Br>
<div align="center">
    <form action="userSearchedTicket.php" method="get" display: inline-block>
        <div align="centre">
            <h4>View Ticket;</h4>
